...
import org.coastline.amber.client.model.RedisRole;
...
public class NodeInfoEntity {
    ...
    public long getSyncFullMin() {
        return syncFullMin;
    }

    public void setSyncFullMin(long syncFullMin) {
        this.syncFullMin = syncFullMin;
    }

    public long getSyncPartialOkMin() {
        return syncPartialOkMin;
    }

    public void setSyncPartialOkMin(long syncPartialOkMin) {
        this.syncPartialOkMin = syncPartialOkMin;
    }

    public long getSyncPartialErrMin() {
        return syncPartialErrMin;
    }

    public void setSyncPartialErrMin(long syncPartialErrMin) {
        this.syncPartialErrMin = syncPartialErrMin;
    }
    ...
    public long getSlowLog() {
        return slowLog;
    }

    public void setSlowLog(long slowLog) {
